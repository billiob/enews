...
static void
_read_cb(Evas_Object *ly,
         Evas_Object *edj,
         const char  *emission,
         const char  *source)
{
    const rss_item_t *item = evas_object_data_get(ly, "item");
